...
#
# Copyright (c) 2018-2021 by Delphix. All rights reserved.
#
...
"""
    ...
    Edited to support multiversion
"""
...
class ApiClient(object):
    ...
    def sanitize_for_serialization(self, obj):
        ...
        # if isinstance(obj, GenericModel) and obj.internal:
        #     return obj.to_dict()
        ...
        if isinstance(obj, dict):
            ...
            if hasattr(obj,'swagger_types') and obj.swagger_types is not None:
                obj_dict = {obj.swagger_map[attr]: getattr(obj, attr)
                            for attr, _ in six.iteritems(obj.swagger_types)
                            if hasattr(obj, attr) and getattr(obj, attr) is not None}
            else:
                # if this is a top level dict - don't convert just return a dictionary
                return obj.to_dict()
    ...
    def __deserialize(self, data, klass):
        ...
        #     else:
        #         klass = getattr(dxm.lib.masking_api.models, klass)
    ...
    def __deserialize_file(self, response):
        ...
        Return data to caller instead of creating temp file
