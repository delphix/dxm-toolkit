...
class DomainApi(object):
    ...
    def create_domain(self, body, **kwargs):  # noqa: E501
        ...
        :param Domain body: The domain to create (required)
        :return: Domain
    ...
    def delete_domain(self, domain_name, **kwargs):  # noqa: E501
        """Delete domain by name  # noqa: E501
        ...
        :param async_req bool
        :param str domain_name: The name of the domain to delete (required)
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        """
    ...
    def delete_domain_with_http_info(self, domain_name, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('domain_name' not in params or
                                                       params['domain_name'] is None):  # noqa: E501
    ...
    def get_all_domains(self, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param int page_number: The page number for which to get domains. This will default to the first page if excluded
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_all_domains_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.get_all_domains_with_http_info(**kwargs)  # noqa: E501
            return data

    def get_all_domains_with_http_info(self, **kwargs):  # noqa: E501
        """Get all domains  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_all_domains_with_http_info(async_req=True)
        >>> result = thread.get()
    ...
    def get_domain(self, domain_name, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param str domain_name: The name of the domain to get (required)
        :return: Domain
                 If the method is called asynchronously,
                 returns the request thread.
        """
    ...
    def get_domain_with_http_info(self, domain_name, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('domain_name' not in params or
                                                       params['domain_name'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `domain_name` when calling `get_domain`")  # noqa: E501
    ...
    def update_domain(self, domain_name, body, **kwargs):  # noqa: E501
        """Update domain by name  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_domain(domain_name, body, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str domain_name: The name of the domain to update (required)
        :param Domain body: The updated domain (required)
        :return: Domain
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.update_domain_with_http_info(domain_name, body, **kwargs)  # noqa: E501
        else:
            (data) = self.update_domain_with_http_info(domain_name, body, **kwargs)  # noqa: E501
            return data

    def update_domain_with_http_info(self, domain_name, body, **kwargs):  # noqa: E501
        """Update domain by name  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_domain_with_http_info(domain_name, body, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('domain_name' not in params or
                                                       params['domain_name'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `domain_name` when calling `update_domain`")  # noqa: E501
        # verify the required parameter 'body' is set
        if self.api_client.client_side_validation and ('body' not in params or
                                                       params['body'] is None):  # noqa: E501
