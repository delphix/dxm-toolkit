...
class CredentialApi(object):
    ...
    def create_credential(self, body, **kwargs):  # noqa: E501
        ...
        :param Credential body: The credential to create (required)
        :return: Credential
    ...
    def delete_credential(self, credential_id, **kwargs):  # noqa: E501
        """Delete credential by ID  # noqa: E501
        ...
        :param async_req bool
        :param int credential_id: The ID of the credential to delete (required)
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        """
    ...
    def get_all_credentials(self, **kwargs):  # noqa: E501
        """Get all credentials  # noqa: E501

        NOTE: Access to the password vault feature is currently restricted. If you are interested in using this feature, please contact your Delphix representative.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_all_credentials(async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param int page_number: The page number for which to get credentials. This will default to the first page if excluded
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_all_credentials_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.get_all_credentials_with_http_info(**kwargs)  # noqa: E501
            return data

    def get_all_credentials_with_http_info(self, **kwargs):  # noqa: E501
        """Get all credentials  # noqa: E501

        NOTE: Access to the password vault feature is currently restricted. If you are interested in using this feature, please contact your Delphix representative.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_all_credentials_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_all_credentials" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='CredentialList',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def get_credential(self, credential_id, **kwargs):  # noqa: E501
        """Get credential by ID  # noqa: E501
        ...
        :param async_req bool
        :param int credential_id: The ID of the credential to get (required)
        :return: Credential
                 If the method is called asynchronously,
                 returns the request thread.
        """
    ...
    def update_credential(self, credential_id, body, **kwargs):  # noqa: E501
        """Update credential by ID  # noqa: E501

        NOTE: Access to the password vault feature is currently restricted. If you are interested in using this feature, please contact your Delphix representative.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_credential(credential_id, body, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param int credential_id: The ID of the credential to update (required)
        :param Credential body: The updated credential (required)
        :return: Credential
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.update_credential_with_http_info(credential_id, body, **kwargs)  # noqa: E501
        else:
            (data) = self.update_credential_with_http_info(credential_id, body, **kwargs)  # noqa: E501
            return data

    def update_credential_with_http_info(self, credential_id, body, **kwargs):  # noqa: E501
        """Update credential by ID  # noqa: E501

        NOTE: Access to the password vault feature is currently restricted. If you are interested in using this feature, please contact your Delphix representative.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_credential_with_http_info(credential_id, body, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['credential_id', 'body']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
