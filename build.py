...
type_file_mapping = {
    ...
    # ,'Analytics'
    ,'Application' : 'DxApplication/Application_mixin.py'
    # ,'ApplicationList'
    # ,'ApplicationSettings'
    ...
    ,'Domain' : 'DxDomain/Domain_mixin.py'
    # ,'DomainList'
    ...
    # ,'PluginBase'
    # ,'Privilege'
    ,'ProfileExpression' : 'DxProfile/ProfileExpression_mixin.py'
    # ,'ProfileTypeExpression'
    # ,'ProfileExpressionList'
    ,'ProfileJob' : 'DxJobs/ProfileJob_mixin.py'
    # ,'ProfileJobList'
    ,'ProfileSet' : 'DxProfile/ProfileSet_mixin.py'
    # ,'ProfileSetList'
    # ,'ReidentificationJob'
