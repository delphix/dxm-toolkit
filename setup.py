...
setup(
    ...
    install_requires=[
        'click == 7.1.2','requests','pytz', "urllib3 >= 1.15", "six >= 1.10", "certifi == 2023.7.22", "python-dateutil == 2.8.1", "colorama == 0.4.3", "tqdm == 4.47.0", "packaging == 20.4", "keyring == 21.2.1", "cryptography == 2.9.2"
    ],
    entry_points='''
        [console_scripts]
        dxmc=dxm.dxm:dxm
